...
<body>
            ...
            <div id="navbar" class="websdktest">
                <form class="navbar-form navbar-right" id="meeting_form">
                    <div class="form-group">
                        <input type="text" name="display_name" id="display_name" value="1.7.10#CDN" maxLength="100" placeholder="Name" class="form-control" required>
                    </div>
                    <div class="form-group">
    ...
    <script src="<?= base_url('assets'); ?>/js/vconsole.min.js"></script>
